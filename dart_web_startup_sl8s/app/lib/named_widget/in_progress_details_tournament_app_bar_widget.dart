...
final class InProgressDetailsTournamentAppBarWidget extends StatelessWidget {
  final String username;
  final String tournamentName;
  final String imageUrl;
  final bool isNetworkImage;

  const InProgressDetailsTournamentAppBarWidget({super.key, required this.username, required this.tournamentName, required this.imageUrl, required this.isNetworkImage});
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  SvgPicture.asset("assets/icons/mobile/in_progress_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
          ...
          child: Row(
            children: [
              ...
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  SvgPicture.asset("assets/icons/tablet/in_progress_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
          ...
          child: Row(
            children: [
              ...
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  SvgPicture.asset("assets/icons/large_tablet/in_progress_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
          ...
          child: Row(
            children: [
              ...
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  SvgPicture.asset("assets/icons/desktop/in_progress_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
          ...
          child: Row(
            children: [
              ...
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  SvgPicture.asset("assets/icons/large_desktop/in_progress_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
          ...
          child: Row(
            children: [
              ...
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  SvgPicture.asset("assets/icons/tv/in_progress_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
