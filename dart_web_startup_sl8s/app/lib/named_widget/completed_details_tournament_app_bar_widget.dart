...
final class CompletedDetailsTournamentAppBarWidget extends StatelessWidget {
  final String username;
  final String tournamentName;
  final String imageUrl;
  final bool isNetworkImage;

  const CompletedDetailsTournamentAppBarWidget({super.key, required this.username, required this.tournamentName, required this.imageUrl, required this.isNetworkImage});
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  SvgPicture.asset("assets/icons/mobile/completed_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
          ...
          child: Row(
            children: [
              ...
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  SvgPicture.asset("assets/icons/tablet/completed_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
          ...
          child: Row(
            children: [
              ...
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  SvgPicture.asset("assets/icons/large_tablet/completed_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
          ...
          child: Row(
            children: [
              ...
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  SvgPicture.asset("assets/icons/desktop/completed_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
          ...
          child: Row(
            children: [
              ...
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  SvgPicture.asset("assets/icons/large_desktop/completed_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
          ...
          child: Row(
            children: [
              ...
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  SvgPicture.asset("assets/icons/tv/completed_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
