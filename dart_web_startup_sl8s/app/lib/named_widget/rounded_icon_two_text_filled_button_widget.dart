...
final class RoundedIconTwoTextFilledButtonWidget extends StatelessWidget {
  final String name;
  final void Function() onPressed;

  const RoundedIconTwoTextFilledButtonWidget({super.key, required this.onPressed, required this.name});
    ...
    return PlatformUtility.getNamedWidgetFromSeven(
      ...
      mobileWidget: ElevatedButton(
          ...
          child: Row(
            ...
            children: [
              SvgPicture.asset("assets/icons/mobile/iconsax_arrow_down_two.svg"),
              SizedBox(width: 10,),
      ...
      tabletWidget: ElevatedButton(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              SvgPicture.asset("assets/icons/tablet/iconsax_arrow_down_two.svg"),
              SizedBox(width: 10,),
              Text(name ,style: textThemeFromContextAndColor.bodySmall),
            ],
          )
      ...
      largeTabletWidget: ElevatedButton(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              SvgPicture.asset("assets/icons/large_tablet/iconsax_arrow_down_two.svg"),
              SizedBox(width: 10,),
              Text(name ,style: textThemeFromContextAndColor.bodySmall),
            ],
          )
      ...
      desktopWidget: ElevatedButton(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              SvgPicture.asset("assets/icons/desktop/iconsax_arrow_down_two.svg"),
              SizedBox(width: 10,),
              Text(name ,style: textThemeFromContextAndColor.bodySmall),
            ],
          )
      ...
      largeDesktopWidget: ElevatedButton(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              SvgPicture.asset("assets/icons/large_desktop/iconsax_arrow_down_two.svg"),
              SizedBox(width: 10,),
              Text(name ,style: textThemeFromContextAndColor.bodySmall),
            ],
          )
      ...
      tvWidget: ElevatedButton(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              SvgPicture.asset("assets/icons/tv/iconsax_arrow_down_two.svg"),
              SizedBox(width: 10,),
              Text(name ,style: textThemeFromContextAndColor.bodySmall),
            ],
          )
