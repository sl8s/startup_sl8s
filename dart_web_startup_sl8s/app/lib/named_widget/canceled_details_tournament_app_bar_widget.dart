...
final class CanceledDetailsTournamentAppBarWidget extends StatelessWidget {
  final String username;
  final String tournamentName;
  final String imageUrl;
  final bool isNetworkImage;

  const CanceledDetailsTournamentAppBarWidget({super.key, required this.username, required this.tournamentName, required this.imageUrl, required this.isNetworkImage});
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  SvgPicture.asset("assets/icons/mobile/canceled_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
          ...
          child: Row(
            children: [
              ...
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  SvgPicture.asset("assets/icons/tablet/canceled_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
          ...
          child: Row(
            children: [
              ...
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  SvgPicture.asset("assets/icons/large_tablet/canceled_ellipse.svg"),
                ],
              ),
              Expanded(
                child: Row(
